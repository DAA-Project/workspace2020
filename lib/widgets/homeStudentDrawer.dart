...
class HomeStudentDrawer extends StatefulWidget {
  static const routeName = '/HomeStudentDrawer';
  @override
  _HomeStudentDrawerState createState() => _HomeStudentDrawerState();
}

class _HomeStudentDrawerState extends State<HomeStudentDrawer>
            ...
            child: Container(
              child: new ListView(
                ...
                children: <Widget>[
                  ...
                  getMaterialResideMenuItem('Profile',
                      MaterialCommunityIcons.account_circle_outline, 2),

                  getMaterialResideMenuItem(
                      'Previous Session', SimpleLineIcons.envelope_letter, 4),

                  getMaterialResideMenuItem(
                      'Account Settings', Feather.settings, 5),
                  getMaterialResideMenuItem('About us', Icons.error, 6),
                ],
              ),
            ),
          ),
